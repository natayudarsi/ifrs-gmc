                                        ...
                                        <table class="table table-borderless table-striped">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $key->no_pembelian;?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Tanggal</td>
                                                        <td><?php echo date("d-m-Y", strtotime($key->tgl_pengiriman));?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>ID Karyawan</td>
                                                    ...
                                                    <tr>
                                                        <td>Nama PBF</td>
                                                        <td><?php echo $key->nama_pbo;?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <a href="<?php echo base_url()?>index.php/pembelian/hapus/<?php echo $key->no_pembelian?>"><span class="btn btn-danger btn-sm"><i class="fa fa-ban"></i> Hapus</a>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                <?php } ?>
